...
class MyOrderProductDetails extends StatefulWidget {
  ...
  const MyOrderProductDetails({Key? key, required this.detailModel})
      : super(key: key);
    ...
    return LayoutBuilder(builder: (context, constraints) {
      ...
      return Column(
        children: [
          ...
          Wrap(
            children: [
              ...widget.detailModel.orderItems!
                  .map((item) => productDetailCard(item))
            ],
          )
        ],
      );
      ...
      child: Row(
        ...
        children: [
          ...
          Column(
            children: [
              productInfoTile(
                  AppLocalizations.of(context)!.product, cartItemModel.title!),
              productInfoTile(AppLocalizations.of(context)!.unitPrice,
              ...
              productInfoTile(
                  ...
                  cartItemModel.totalAmount.toString() +
                      " " +
