          ...
          child: ListTileTheme(
            ...
            child: Column(
              ...
              children: [
                ...
                CustomText(text:"NAME",padding: const EdgeInsets.only(bottom: 10),),
                CustomText(text:"EMAIL",padding: EdgeInsets.only(bottom: 10)),
                ListTile(
                  onTap: () {
                ...
                ListTile(
                  onTap: () {
                    navigationService.navigateTo(Routes.customerSupportScreenRoute);
                  },
                ...
                ListTile(
                  onTap: () {
                    navigationService.navigateTo(Routes.couponsSupportScreenRoute);
                  },
